...
<article id="post-<?php the_ID(); ?>" <?php post_class(); ?>>
	<header class="entry-header">
		...
		<div class="entry-meta">
			...
			<span class="cat-links">
				<?php printf( __( '<i class="fa fa-folder-o"></i> %1$s', 'bootville-lite' ), $categories_list ); ?>
			</span>
			<?php endif; // End if categories ?>
		<?php endif; // End if 'post' == get_post_type() ?>

		<?php if ( ! post_password_required() && ( comments_open() || '0' != get_comments_number() ) ) : ?>
		<span class="comments-link"><i class="fa fa-comment-o"></i> <?php comments_popup_link( __( 'Leave a comment', 'bootville-lite' ), __( '1 Comment', 'bootville-lite' ), __( '% Comments', 'bootville-lite' ) ); ?></span>
		<?php endif; ?>
		</div><!-- .entry-meta -->	
	...
	<div class="entry-content">
		...
		<?php the_content( __( 'Continue reading <span class="meta-nav">&rarr;</span>', 'bootville-lite' ) ); ?>
			<?php } ?>
		<?php
			wp_link_pages( array(
